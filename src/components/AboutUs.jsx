...
const AboutUs = () => {
  ...
  return (
    <div>
        ...
        <p className="pt-3 text-[20px]">"Our goal at Vell Magazine is to provide a platform for diverse voices to be heard, and to spark meaningful conversations around the most pressing issues of our time."</p>
