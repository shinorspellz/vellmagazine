...
const Sidebar = ({ setIsShow, isShow }) => {
  ...
  return (
    <div
      className={`${
        isShow
          ? "block  w-full sidebar absolute top-[45px] right-0 lg:hidden  pb-12  "
          : "hidden w-full sidebar absolute top-[45px] right-0 pb-12 "
      } lg:hidden `}
    >
      <section className="justify-between items-end p-3 xl:hidden flex flex-col">
        ...
        >
          ...
          <option
            ...
            className="py-2 font-bold cursor-pointer text-[13px] px-1"
          >
            DECEMBER
          </option>
          <option
   ...
   <button
    ...
    "
        ...
        <NavLink
          to="/today"
          className={({ isActive }) =>
            isActive ? "font-bold text-[17px]" : "font-normal text-[17px]"
          }
        ></NavLink>
        <NavLink
          to="/subscribe"
