...
export const headerSliderData = [
  ...
  },
  {
    ...
    content: `Are you a TikTok user baffled by the sudden number of unknown cover versions by famous artists on your FYP? Recently a version of Just the Two of Us by Kanye West caught my eye, and ear. That’s different I thought; a softer, more melodic version of West- why not? I scrolled on, thinking no more of it. That is until I came across the Kanye West version of Lana del Rey’s Video Games.Video Games is, in my opinion, one of the greatest love songs ever. Yes, ever. Such is del Rey’s talent, it’s hard to imagine a cover version that could even touch the original version, her haunting, deep voice simply perfection.I checked myself. Why shouldn’t Kanye West turn his own undisputed talents to something like this?
  `,
    month: "APR 2023 EDITION",
  ...
  },
  {
    ...
    content: `
    Dungeons and Dragons: Honour Among Thieves is Hasbro’s first attempt to adapt the popular table-top roleplaying game into a major motion picture. The film is certainly off to a good start, receiving positive reviews from fans and critics alike. After seeing it with a party of mine own, it’s easy to understand why. The combination of practical effects and CGI creates some excellent creatures and spell effects, and all the action scenes are dynamic and engaging to watch. However, there is one aspect that might frustrate hardcore D&D fans.The main party is simply not very fantastical when you look at the options presented in D&D’s current core rulebooks. Consisting of two humans, a half-elf, and a tiefling, it feels very much like a party designed for an easy introduction to Dungeons and Dragons, rather than one that truly shows the creativeness of the Forgotten Realm’s setting. And this is obvious when you closely examine the tiefling party member. Warning for some mild spoilers coming up.
    `,
    month: "APR 2023 EDITION",
    img: "/images/dnd.png",
    img_source:
  ...
  },
  {
    ...
    content:
      "The recent divorce story of Moroccan footballer Achraf Hakimi has caused quite a stir in the media. His ex-wife Hiba Abouk, who reportedly asked for half of his fortune in the divorce settlement, discovered that there was nothing in his name to claim.According to recent reports, high-profile divorces in the world of sports are becoming increasingly common, with some women seeking to claim a significant portion of their former partner's wealth. The cases of former Arsenal player Emmanuel Eboue and Moroccan footballer Achraf Hakimi are two such examples that have sparked intense debate.Eboue's ex-wife Aurelie filed for divorce in 2017, claiming half of his wealth. The couple had been married for over a decade and had three children together. However, after a difficult legal battle, it was revealed that Eboue had lost all of his wealth due to a combination of financial mismanagement and a contentious divorce settlement. The former player was left homeless and struggling to rebuild his life.",
    month: "APR 2023 EDITION",
  ...
  },
  {
    ...
    content:
      "Dame Mary Quant, who passed away at the age of 90, was a visionary designer whose influence can still be seen in the world of fashion today. Born in London in 1934, she studied illustration at Goldsmiths College before opening her first boutique, Bazaar, on King's Road in 1955. Her designs quickly gained a following, and by the 1960s, she was a household name.Quant is best known for her playful, youthful designs, which helped define the Swinging Sixties. She is credited with popularising the mini skirt, which she designed in 1965, and hot pants, which made their debut in 1970. Her bold use of colour and pattern, as well as her experimentation with new materials such as PVC, were also groundbreaking at the time.But Quant's influence extends beyond her contributions to design. She was also a trailblazer for women in business, founding her own fashion label and building it into a global empire. She was one of the first designers to understand the importance of licensing her name and designs, and her products were sold in over 100 countries around the world.",
    month: "APR 2023 EDITION",
  ...
  },
  {
    ...
    content:
      "Few will have failed to notice Ryan Reynolds and Rob McElhenny’s Wrexham making headlines and breaking records in recent weeks. Owning a football is nothing new for celebrities; think Elton John at Watford, Alan Sugar or even Delia Smith at Norwich as just three examples.What’s perhaps less well-known are the growing number of celebrities investing in football clubs both in the UK and in the States. Here are some familiar faces who double as football club owners.Lebron James: Liverpool FC.LeBron is said to own a 2% stake in the Merseyside club, reportedly investing 4.9 million pounds in 2011. Thanks to the success the club has enjoyed in the subsequent years, this investment looks like a savvy one, his initial investment estimated to have grown to around 24 million.Michael B Jordan: Bournemouth FC.Michael B. Jordan, star of films Black Panther and Creed, is a minority stakeholder in the south coast team. Jordan joined a consortium of investors with Bill Foley, an American billionaire, who invested in the team in 2022 following their promotion to the Premier League in 2021. Jordan explained that his presence could help raise the profile of the team, explaining, “I'm just ready to kind of maximise potential, see what I can bring to the table, help bring the popularity of the players in the team up”.",
    month: "APR 2023 EDITION",
